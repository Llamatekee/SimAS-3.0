...
public class SimulacionFinal extends BorderPane implements ActualizableTextos {
    ...
    private String generarDotDesdeArbol(NodoArbol raiz) {
        ...
        int[] idCounter = {0};
        java.util.List<String> hojas = new java.util.ArrayList<>();
    ...
    private void generarDotRec(NodoArbol nodo, StringBuilder sb, int[] id, String parentId, java.util.List<String> hojas) {
        String myId = "n" + id[0]++;
